...
SIGNAL_FILE = os.path.join(MT5_COMMON_PATH, "python_bridge_v3_signal.csv")

# Execution confirmation file that MT5 writes and Python reads
CONFIRMATION_FILE = os.path.join(MT5_COMMON_PATH, "python_bridge_v3_confirm.csv")

# Tick data file that MT5 writes and Python reads (v3 order flow features)
TICK_DATA_FILE = os.path.join(MT5_COMMON_PATH, "python_bridge_v3_tick_data.csv")

# Spread file that MT5 writes and Python reads (v3 spread gating)
SPREAD_FILE = os.path.join(MT5_COMMON_PATH, "python_bridge_v3_spread.csv")
...
# ─────────────────────────────────────────────
#  V3 TIER 1: TICK DATA / ORDER FLOW
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 2: MICROSTRUCTURE FEATURES
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 1: REGIME-SPECIFIC MODEL ROUTING
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 1: WALK-FORWARD RETRAINING
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 1: ADVERSARIAL SIGNAL FILTER
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 2: SPREAD/SLIPPAGE GATE
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 2: CORRELATION REGIME DETECTION
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 2: ADAPTIVE CONFIDENCE THRESHOLD
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 3: MULTI-MODEL DISAGREEMENT SIGNAL
# ─────────────────────────────────────────────
@dataclass
...
# ─────────────────────────────────────────────
#  V3 TIER 3: KELLY CRITERION POSITION SIZING
# ─────────────────────────────────────────────
@dataclass
class KellyConfig:
...
# ─────────────────────────────────────────────
#  V3 TIER 3: MONTE CARLO RISK SIMULATION
# ─────────────────────────────────────────────
@dataclass
