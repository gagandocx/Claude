...
class BayesianConfidence:
    ...
    _LIKELIHOODS = {
        ...
        # Circuit breaker: groupthink penalty evidence
        'groupthink_danger':   (0.30, 0.80),   # DANGER: 95%+ agreement 3+ cycles
        'groupthink_caution':  (0.42, 0.65),   # CAUTION: 85%+ agreement 2+ cycles
    }
