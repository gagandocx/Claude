...
set "ROOT_FILES=__init__.py config.py data_loader.py backtest_engine.py live_trader.py run_demo.py run_backtest.py run_optimized_backtest.py run_optimized_local.py run_hft_pro.py README.md"
